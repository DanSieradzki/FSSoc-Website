...
<body>
            ...
            <header>
                ...
                <ul class="topNavClass">
                    <li class="topNavLi one">
                        <a href="home.html" id="Home" class="topNavBtn">Home</a>
                        <div class="dropdown">
                            <a href="#">Gallery</a>
                            <a href="#">News</a>
                        </div>
                 ...
                 --><li class="topNavLi two">
                        <a href="projects.html" id="Projects" class="topNavBtn">Projects</a>
                        <div class="dropdown">
                            <a href="#">It Flies</a>
                            <a href="#">Pheonix</a>
                            <a href="#">3rd Year Projects</a>
                            <a href="#">4th Year Projects</a>
                        </div>
                    </li><!-- 
                 --><li class="topNavLi three">
                        <a href="#" id="Calendar" class="topNavBtn">Calendar</a>
                        <div class="dropdown">
                            <a href="#">Events</a>
                 ...
                 --><li class="topNavLi six">
                    ...
                    <hr id="headerHr" style="transform: translate(200%) perspective(100px) rotateX(45deg);">
                </ul>
    ...
    <div id="myhbSidenav" class="hbsidenav">
        ...
        <a href="projects.html" class="accordion">Projects</a>
        ...
        <a href="tutorials.html" class="accordion">Tutorials</a>
...
<div id="container">
     <!-- <div class-"wallpaper">        
        <iframe id="wallpaper" src="https://www.youtube.com/watch?v=b6sV_TXOE94"></iframe> -->
        <div class="wallpaperBar">
            <h1>Flight Simulation Society Calendar</h1>
            <h2>FSSoc Calendar</h2>
        </div>
    </div>
