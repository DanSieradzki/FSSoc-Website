<footer>
    <div class="footerMenu">
        <div class="footerList">
            <a class="footerListTitle" href="index.php">Home</a><br>
        ...
        <div class="footerList">
            <a class="footerListTitle" href="calendar.php">Calendar</a><br>
            <ul class="footerList0">
                <li>
                    <a href="#">Events</a><br>
                </li>
        ...
        <div class="footerList">
            <a class="footerListTitle" href="tutorials.php">Tutorials</a><br>
            <ul class="footerList0">
                <li>
        ...
        <div class="footerList">
            <a class="footerListTitle" href="http://www.fssoc.co.uk/intranet.php">Intranet</a><br>
        </div>
        <div class="footerList">
            <a class="footerListTitle" href="contact.php">Contact</a><br>
            <ul class="footerList0">
                <li>
                    <a href="#">Team</a><br>
                </li>
